...
**
** Created: Thu Apr 16 21:16:42 2009
...
public:
    ...
    void retranslateUi(QWidget *PictureWallMainWindowDesignerUI)
    {
        ...
        m_pCurrentOpenDirectoryPathLabel->setText(QApplication::translate("PictureWallMainWindowDesignerUI", "TextLabel", 0, QApplication::UnicodeUTF8));
